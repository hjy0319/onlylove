...
public class MailUtils {
    ...
    private static final String SEND_MAIL_ACCOUNT = "onlylove666666@163.com";
    private static final String SEND_MAIL_PASSWORD = "NCWAJAXPTRLUTEEG";
    ...
    public static void sendMail(String receiveMailAccount, String title, String content) throws Exception {
        ...
        //
        transport.connect(SEND_MAIL_ACCOUNT, SEND_MAIL_PASSWORD);
